...
<div>
    ...
    <div class="position-relative form-group">
        <label for="file-ijazah-pt" class="font-weight-bold">Dokumen Ijazah <small class="text-primary">*) format file pdf, maksimal 1 MB</small></label>
        <input name="file_ijazah_pt" accept="application/pdf" id="file-ijazah-pt" accept="application/pdf" type="file" class="form-control-file @error('file_ijazah_pt') is-invalid @enderror">
        @error('file_ijazah_pt')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
            ...
            <div id="accordion" class="accordion-wrapper mb-3">
                <div class="card">
                    ...
                    <div data-parent="#accordion" id="collapseOne" class="collapse">
                        <div class="card-body">
                            <iframe
                                src="{{ route('nonasn.pendidikan.file-ijazah-pt', ['file' => $data->file_ijazah_pt]) }}"
                                align="top"
                                height="800"
                                width="100%"
                                frameborder="0"
    ...
    <div class="position-relative form-group">
        <label for="file-nilai-pt" class="font-weight-bold">Dokumen Transkrip Nilai <small class="text-primary">*) format file pdf, maksimal 1 MB</small></label>
        <input name="file_nilai_pt" accept="application/pdf" id="file-nilai-pt" accept="application/pdf" type="file" class="form-control-file @error('file_nilai_pt') is-invalid @enderror">
        @error('file_nilai_pt')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
            ...
            <div id="accordion2" class="accordion-wrapper mb-3">
                <div class="card">
                    ...
                    <div data-parent="#accordion2" id="collapseOne2" class="collapse">
                        <div class="card-body">
                            <iframe
                                src="{{ route('nonasn.pendidikan.file-transkrip-pt', ['file' => $data->file_nilai_pt]) }}"
                                align="top"
                                height="800"
                                width="100%"
                                frameborder="0"

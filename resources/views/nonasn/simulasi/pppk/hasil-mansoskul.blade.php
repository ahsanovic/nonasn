...
<x-app-layout>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card main-card mb-3">
                <div class="card-header">
                    Nilai Simulasi Tes PPPK Manajerial/Sosio Kultural
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <ul class="list-unstyled text-left" style="font-weight: 500;">
                                <li>Tes Manajerial</li>
                            </ul>
                        </div>
                        <div class="col-1">
    ...
    <div class="row justify-content-center mt-2">
        <x-button-loader />
        <form id="form" method="post" action="{{ route('nonasn.simulasi.pppk.store-mansoskul') }}">
            @csrf

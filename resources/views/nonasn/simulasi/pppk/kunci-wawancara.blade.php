<x-app-layout>
    <x-page-header-nonasn>
        <div>
            Kunci Jawaban Simulasi Tes PPPK - Wawancara
        </div>
    </x-page-header-nonasn>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col md-6 lg-12 mt-4 d-flex">
                            <a class="btn btn-sm btn-square btn-dark mr-2 @if ($nomor_sekarang == 1) @php echo 'disabled'; @endphp @endif"
                                href="{{ route('nonasn.simulasi.pppk.kunci-wawancara', ['ujian' => $ujianId, 'no' => $nomor_sekarang - 1]) }}">
                                <i class="bi bi-chevron-left"></i> Soal Sebelumnya
                            </a>
                            <a class="btn btn-sm btn-square btn-primary @if ($nomor_sekarang == 10) @php echo 'disabled'; @endphp @endif"
                                href="{{ route('nonasn.simulasi.pppk.kunci-wawancara', ['ujian' => $ujianId, 'no' => $nomor_sekarang + 1]) }}">
                    ...
                    <div class="row">
                        <div class="col md-6 lg-12">
                            <h5 class="text-success">Jawaban Benar (poin 4-3-2-1): {{ $kunci[$nomor_sekarang - 1] }}</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group mr-2 mb-2" role="group" aria-label="First group">
            <a 
                href="{{ route('nonasn.simulasi.pppk.kunci-wawancara', ['ujian' => $ujianId, 'no' => $nomor_soal]) }}"

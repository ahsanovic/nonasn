...
<x-app-layout>
    ...
    <div class="row mb-2">
        <div class="col-md-2">
            <div class="alert alert-success fade show text-center" role="alert" id="alert">
                Soal Dijawab: {{ 10 - $jawaban_kosong }}
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <form
                id="form-finish"
                method="post"
                action="{{ route('nonasn.simulasi.pppk.destroy-wawancara', ['idUjian' => $id_ujian]) }}"
            >
                @csrf
                @method('delete')
            </form>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-12">
                            <form id="form-save" method="post" action="{{ route('nonasn.simulasi.pppk.update-wawancara', $nomor_sekarang) }}">
                                @method('put')
                                @csrf
                    ...
                    <div class="row">
                        <div class="col md-6 lg-12 mt-4 d-flex">
                            ...
                            <a 
                                class="btn btn-sm btn-square btn-danger <?php if ($nomor_sekarang == 10) echo 'disabled'; ?>"
                                id="btn-skip"
                                href="{{ route('nonasn.simulasi.pppk.show-wawancara', ['id' => $nomor_sekarang + 1]) }}">Lewati Soal
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group mr-2 mb-2" role="group" aria-label="First group">
            <a 
                href="{{ route('nonasn.simulasi.pppk.show-wawancara', ['id' => $nomor_soal]) }}"

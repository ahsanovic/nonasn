<x-app-layout>
    <x-page-header-nonasn>
        <div>
            Kunci Jawaban Simulasi Tes PPPK - Kompetensi Teknis
        </div>
    </x-page-header-nonasn>
                    ...
                    <div class="row">
                        <div class="col md-6 lg-12 mt-4 d-flex">
                            <a class="btn btn-sm btn-square btn-dark mr-2 @if ($nomor_sekarang == 1) @php echo 'disabled'; @endphp @endif"
                                href="{{ route('nonasn.simulasi.pppk.kunci-teknis', ['ujian' => $ujianId, 'no' => $nomor_sekarang - 1]) }}">
                                <i class="bi bi-chevron-left"></i> Soal Sebelumnya
                            </a>
                            <a class="btn btn-sm btn-square btn-primary @if ($nomor_sekarang == 90) @php echo 'disabled'; @endphp @endif"
                                href="{{ route('nonasn.simulasi.pppk.kunci-teknis', ['ujian' => $ujianId, 'no' => $nomor_sekarang + 1]) }}">
    ...
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group mr-2 mb-2" role="group" aria-label="First group">
            <a 
                href="{{ route('nonasn.simulasi.pppk.kunci-teknis', ['ujian' => $ujianId, 'no' => $nomor_soal]) }}"

        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card card-hover-shadow-2x">
                <div class="card-body">
                    ...
                    <a
                        href="{{ route('nonasn.penilaian.create') }}"
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->file)
                                                    <a href="{{ route('nonasn.penilaian.file', ['file' => $item->file]) }}" target="_blank">
                                            ...
                                            <td>
                                                ...
                                                >
                                                    <a 
                                                        href="{{ route('nonasn.penilaian.edit', ['id' => $hashId->encode($item->id_ptt_penilaian)]) }}"
                                                        type="button"
                                                        tabindex="0"
                                                        class="dropdown-item"
                                                    >
                                                    ...
                                                    <form
                                                        ...
                                                        method="post"
                                                        action="{{ route('nonasn.penilaian.destroy', ['id' => $hashId->encode($item->id_ptt_penilaian)]) }}"
                                                    >
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                    <button
                                                        onclick="deleteRow('{{ $hashId->encode($item->id_ptt_penilaian) }}')"
                                                        tabindex="0"
                                                        class="dropdown-item"
                                                    >
                                                        Hapus

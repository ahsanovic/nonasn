...
<div>
    ...
    <div class="position-relative form-group">
        ...
        <input name="file_bpjs" id="file" accept="image/jpg, image/jpeg, image/png" type="file" class="form-control-file @error('file_bpjs') is-invalid @enderror">
        @error('file_bpjs')
        <div class="invalid-feedback">
            {{ $message }}
        </div>
                ...
                <div id="accordion" class="accordion-wrapper mb-3">
                    <div class="card">
                        ...
                        <div data-parent="#accordion" id="collapseOne2" class="collapse">
                            <div class="card-body">
                                <iframe
                                    src="{{ route('nonasn.suami-istri.file', ['file' => $pasangan->file_bpjs]) }}"
                                    align="top"
                                    height="800"
                                    width="100%"
                                    frameborder="0"

<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-6 col-xl-5">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    <div class="widget-title opacity-5 text-muted text-uppercase mb-3">TOP FIVE LIST</div>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <div class="main-card mb-3 card">
                <div class="card-body"><h5 class="card-title">Pengumuman CPNS dan PPPK Pemprov Jatim</h5>

...
<x-app-layout>
    ...
    <x-tab-button />
    <x-card>
        <h5 class="card-title">Rekap Simulasi Tes Manajerial/Sosio Kultural</h5>
        <div class="row mb-3 justify-content-between">
            ...
            <div class="col-md-2 mb-2">                
                <form method="post" action="{{
                    route('fasilitator.download-rekap-simulasi-pppk-mansoskul', ['daterange' => request()->daterange, 'niptt' => request()->niptt, 'skpd' => request()->skpd])
                }}">
                    @csrf
        ...
        <form id="form" method="get" action="{{ url()->current() }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2 mt-2">
                    <br />
                    <a href="{{ route('fasilitator.rekap-simulasi-pppk-mansoskul') }}" class="btn btn-sm btn-hover-shine btn-square btn-danger">Reset</a>
                ...
                <tbody>
                    @forelse ($data as $key => $item)
                        <tr>
                            ...
                            <td>{{ $item->nilai_manajerial }}</td>
                            <td>{{ $item->nilai_soskul }}</td>

...
<x-app-layout>
    <x-page-header>
        <div>
            Log Fasilitator
            <div class="page-title-subheading">Rekap Log Fasilitator</div>
        </div>
    </x-page-header>
    <x-card>
        <h5 class="card-title">Rekap Log User Fasilitator</h5>
        ...
        <form id="form" method="get" action="{{ url()->current() }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" name="username" value="{{ request()->input('username') }}" />
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2 mt-2">
                    <br />
                    <a href="{{ route('fasilitator.rekap-log-fasilitator') }}" class="btn btn-sm btn-hover-shine btn-square btn-danger">Reset</a>

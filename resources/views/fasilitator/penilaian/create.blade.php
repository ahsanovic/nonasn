    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="main-card mb-3 card card-hover-shadow-2x">
                <div class="card-body">
                    <h5 class="card-title">Tambah Penilaian</h5>
                    <div class="mt-4">
                        <form
                            id="form"
                            method="post"
                            action="{{ route('fasilitator.penilaian.store', ['idSkpd' => $hashidSkpd->encode($skpd->id), 'id' => $hashidPegawai->encode($pegawai->id_ptt)]) }}"
                            enctype="multipart/form-data"
                        >
                            @csrf
                            @include('fasilitator.penilaian._form')
                        </form>
                    </div>
                </div>
            </div>

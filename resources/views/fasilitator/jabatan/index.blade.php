                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="alert alert-danger fade show" role="alert">
                                Pastikan data jabatan terakhir diaktifkan dengan menekan tombol aksi kemudian "Aktifkan"
                            </div>    
                        </div>    
                    </div>
                    <a href="{{
                        route('fasilitator.jabatan.create', [
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->file)
                                                    <a href="{{ route('jabatan.file', ['file' => $item->file]) }}" target="_blank">
                                            ...
                                            <td>
                                                ...
                                                >
                                                    <a 
                                                        href="{{
                                                            route('fasilitator.jabatan.edit', [
                                                                'idSkpd' => $hashidSkpd->encode($skpd->id),
                                                                'id' => $hashidPegawai->encode($pegawai->id_ptt),
                                                                'idJabatan' => $hashid->encode($item->id_ptt_jab)
                                                            ])
                                                        }}"
                                                        type="button"
                                                        tabindex="0"
                                                    ...
                                                    <form method="post" action="{{ route('fasilitator.jabatan.activate', ['id' => $hashid->encode($item->id_ptt_jab)]) }}">
                                                        @csrf
                                                        @method('put')
                                                    ...
                                                    <form
                                                        ...
                                                        method="post"
                                                        action="{{ route('fasilitator.jabatan.destroy', ['id' => $hashid->encode($item->id_ptt_jab)]) }}"
                                                    >
                                                        @csrf
                                                        @method('delete')
                                                    </form>

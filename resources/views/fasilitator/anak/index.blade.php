        ...
        <div class="col-md-9">
            <div class="main-card mb-3 card card-hover-shadow-2x">
                <div class="card-body">
                    ...
                    <a href="{{ route('fasilitator.anak.create', ['idSkpd' => $hashidSkpd->encode($skpd->id), 'id' => $hashidPegawai->encode($pegawai->id_ptt)]) }}" class="btn-square btn btn-sm btn-hover-shine btn-primary mt-3">Tambah</a>
                    <div class="mt-4">
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td align="center">
                                                @if ($item->file_bpjs)
                                                <a href="{{ route('anak.file', ['file' => $item->file_bpjs]) }}" target="_blank">
                                            ...
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    <form
                                                        ...
                                                        method="post"
                                                        action="{{ route('fasilitator.anak.destroy', ['id' => $hashid->encode($item->anak_id)]) }}"
                                                    >
                                                        @csrf
                                                        @method('delete')
                                                    </form>

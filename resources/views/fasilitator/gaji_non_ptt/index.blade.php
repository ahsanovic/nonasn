                                            ...
                                            <td>
                                                ...
                                                >
                                                    ...
                                                    <form
                                                        ...
                                                        method="post"
                                                        action="{{ route('fasilitator.gajinonptt.destroy', ['id' => $hashid->encode($item->id)]) }}"
                                                    >
                                                        @csrf
                                                        @method('delete')
                                                    </form>
